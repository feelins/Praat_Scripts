...
# Copyright 2019.06.14 feelins[feipengshao@163.com]

form Information
	comment Directory path of input files:
	text input_directory /home/shaopf/study/Praat_Scripts/Replace/old_TextGrid/
    comment Path of map list file:
	text list_path /home/shaopf/study/Praat_Scripts/Replace/replace_list.txt
	comment Target Tier:
	positive reference_tier 1
	comment Path of output result file:
	text save_path /home/shaopf/study/Praat_Scripts/Replace/new_TextGrid/
endform
...
Create Strings as file list: "fileList", input_directory$ + "*.interval"
